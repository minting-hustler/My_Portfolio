  ...
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20 '>
        <div className='w-1/2 flex h-full flex-col justify-between '>
            ...
            <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-5'> Technical Skills -</h1>
            {/* <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-5'>&</h1>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-5'>Relevant </h1>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-5'>Coursework</h1> */}
            </div>
